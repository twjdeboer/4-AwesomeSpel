...
public class EvidenceBehviour : MonoBehaviour {
	...
	Vector3 pickRandom(){
		...
		float[] yCord = {-0.32f, 0.24f, 0.111f, 0.4f, 0.4f, 0.4f, -0.06f, 0.02f, 0.05f, 0.186f, 0.18f, 0.186f, 0.879f, 0.088f, 0.167f, 0.480f, 0.76f, 0.7f, 0.205f, 0.205f, 0.21f, 0.429f, 2.646f, 0.268f, 0.114f, 0.11f, 0.11f};
