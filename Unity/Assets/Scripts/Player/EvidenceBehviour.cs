...
public class EvidenceBehviour : MonoBehaviour {
	...
	Vector3 pickRandom(){
		...
		float[] xCord = {297.23f, 316.22f, 285.15f, 5f, 6f, 1.3f, -2.28f, 38.8f, -15.5f, 7.21f, -83.61f, -114.6f, 262.9f, 253.7f, 253.3f, 298.0f, -95.06f, -40.55f, 86.3f, 46.5f, 283.4f, -2.54f, 0.53f, -0.64f, -106.5f, -114.8f, -97.7f};
		float[] yCord = {-0.02f, 0.3f, 0.2f, 0.4f, 0.4f, 0.4f, -0.07f, 0.03f, 0.06f, 0.19f, 0.2f, 0.19f, 0.89f, 0.09f, 0.17f, 0.49f, 0.78f, 0.72f, 0.22f, 0.22f, 0.22f, 0.43f, 0.1f, 0.27f, 0.12f, 0.12f, 0.12f};
		float[] zCord = {-129.21f, -63.66f, -87.72f, 7f, 2f, 8.5f, -4.14f, -54.14f, 33.28f, -86.02f, -145.8f, 82.5f, -183.8f, -198.2f, -164.4f, -131.3f, -216.2f, -3.89f, 86f, 153.7f, 83.5f, -0.85f, 2.761f, 5.47f, -211.5f, -212.4f, -223.8f};
